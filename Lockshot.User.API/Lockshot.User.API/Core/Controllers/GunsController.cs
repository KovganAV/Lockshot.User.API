...
namespace Lockshot.User.API.Core.Controllers
{
    ...
    public class GunsController : ControllerBase
    {
        ...
        //public async Task<IActionResult> GetMostGunByNameGun(int userId, int Id)
        //{
        //    var guns = await _gunService.GetMostGunByNameGun(userId, Id);
